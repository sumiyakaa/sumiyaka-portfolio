...
export function buildXlsx(sheets: readonly XlsxSheetInput[]): Uint8Array {
  ...
  // 生成元のメタ情報（ファイルのプロパティに残る権利表示。防御ではなく出所の明示）
  const coreXml =
    XML_DECL +
    `<cp:coreProperties xmlns:cp="http://schemas.openxmlformats.org/package/2006/metadata/core-properties" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">` +
    `<dc:creator>AKASHIKI Tools (akashiki.com)</dc:creator>` +
    `<cp:lastModifiedBy>AKASHIKI Tools</cp:lastModifiedBy>` +
    `<dc:description>Generated by AKASHIKI Tools — © 灯敷 / SUMIYAKA. Proprietary software. https://akashiki.com/tools/terms</dc:description>` +
    `</cp:coreProperties>`;
  const appXml =
    XML_DECL +
    `<Properties xmlns="http://schemas.openxmlformats.org/officeDocument/2006/extended-properties" xmlns:vt="http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes">` +
    `<Application>AKASHIKI Tools (akashiki.com)</Application>` +
    `<Company>灯敷（AKASHIKI）</Company>` +
    `</Properties>`;
