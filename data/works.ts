...
export const works: Work[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    summary:
      "杉並・中野・世田谷エリアに密着する架空の不動産会社サイト。全画面動画で3エリアを切り替えるヒーロー、賃貸・売買の物件一覧（絞り込み・並び替え）、編集型の物件詳細6件（ギャラリー・モーダル・パノラマ内見）、会社概要・スタッフ・オーナー向け・お客様の声・コラム・採用・お問い合わせ・お気に入りの全18ページ構成。上質ミニマルな白基調にマゼンタを差し色とし、Bebas Neueの特大英字と繊細な和文を組み合わせたエディトリアルなデザイン。",
    challenge:
