...
const EDUCATION_BODY = [
  ...
  "ツールをお渡しするだけでは、業務は変わりません。どの作業をAIに任せ、どこに人の判断を残すかを一緒に決め、社員の方と並んで手を動かし、手順書に落とし、使いこなせるようになるまで伴走します。",
];
...
const TRUST = [
  ...
  },
  {
    ...
    desc: "AIに何を渡し、何を渡さないか。どこまで自動で動かし、どこで止めるか。これは気合ではなく設計の問題で、専門の知識が要ります。私は大手美容外科クリニックで正社員として7年、人体の情報という最上級のプライバシーを扱うシステムのデータ保守とセキュリティを担ってきました。",
  },
  {
    num: "03",
    title: "私自身が、そう使っています",
