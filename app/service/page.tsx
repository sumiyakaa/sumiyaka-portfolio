...
const EDUCATION_BODY = [
  ...
  "AIには、御社の仕事のやり方を一つずつ教え込みます。一つの作業だけを速くするのではなく、情報を集めてから、揃えて、出すまでの一連の流れをまるごと任せられる形に組みます。点で入れたAIは、普段はきちんと動いても、想定外のことが起きたときに止まってしまう。止まったときにどう対処するかを自分で考えられる社員の方を育てるところまでが、設計と教育です。",
