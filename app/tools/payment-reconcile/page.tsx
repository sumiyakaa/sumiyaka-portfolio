...
export const metadata: Metadata = {
  ...
  description:
    "銀行の入出金明細CSVと請求台帳を読み込むと、入金済み・要確認・未入金の3つに分かれます。振込名義のカナのゆれ、手数料の差引、合算入金、分割入金にも理由つきで対応。ファイルはブラウザの中だけで処理され、外部へ送信されません。",
  alternates: { canonical: "/tools/payment-reconcile" },
  openGraph: {
    title: "入金消込 突合 — AKASHIKI Tools",
    description:
      "銀行の入出金明細と請求台帳を突き合わせ、入金済み・要確認・未入金に分けます。データは端末の外に出ません。",
